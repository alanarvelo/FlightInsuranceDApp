...
contract('Flight Surety Tests', async (accounts) => {
    ...
    // NOTE: Though it makes more sense to test the Airlines functionality first, as it better follows the DApps
    // user story, when running all the tests together was getting the infamous 
    // Error: the tx doesn't have the correct nonce. account has nonce of: 119 tx has nonce of: 118
    // Just by moving the Passengers test before the Airline's, the error disappeared
